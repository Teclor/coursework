...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.settings.addAction(self.load)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dictionaries.setText(_translate("MainWindow", "Выбрать словарь"))
        self.load.setText(_translate("MainWindow", "Загрузить словарь"))
